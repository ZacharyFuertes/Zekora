    ...
    <div className="min-h-dvh flex items-center justify-center p-4">
      <div className="flex w-full max-w-md flex-col items-center gap-5">
        ...
        <aside className="flex w-full flex-col items-center text-center">
          ...
          />
          <p className="relative mt-4 border-2 border-neon bg-surface px-4 py-3 font-pixel text-[10px] uppercase leading-relaxed tracking-wide text-secondary shadow-[3px_3px_0_0_rgba(255,45,120,0.35)] before:absolute before:-top-2 before:left-1/2 before:h-3 before:w-3 before:-translate-x-1/2 before:rotate-45 before:border-l-2 before:border-t-2 before:border-neon before:bg-surface">
